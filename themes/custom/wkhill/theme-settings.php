 ...
 */
function wkhill_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['wkhill_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('wkhill sample setting'),
  '#default_value' => theme_get_setting('wkhill_example'),
